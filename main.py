...
async def connect_robot():
    opts = RobotClient.Options.with_api_key(
        api_key='x2ezat2mt9qoon9dy0j1pvcsf650dq4z',
        api_key_id='b98271de-fa2e-4127-9ee2-446933f1f0ed'
    )
    return await RobotClient.at_address('ai-stethoscope-main.bsuz96n8g8.viam.cloud', opts)
